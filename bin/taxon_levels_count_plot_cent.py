...
ax.legend(handles=legend_patches, bbox_to_anchor=(1.130, 0.99), loc='right', prop={'size': 8})

# Save the plot to a larger PNG file
plt.savefig(args.Cent_plot_output_directory+'taxon_levels_count_plot_cent.png', dpi=300)  # Change the filename and format as needed
