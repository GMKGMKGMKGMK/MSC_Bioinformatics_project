...
def main(centrifuge_report, kraken2_report, braken_report, output_loc):
    ...
    print(centrifuge_results)
    print(kraken2_results)
    print(braken_results)
    ...
    save_to_csv(output_loc + "/centrifuge_results_" + basecaller_mapping[centrifuge_report] + ".csv", centrifuge_results)
    save_to_csv(output_loc + "/kraken2_results_" + basecaller_mapping[kraken2_report] + ".csv", kraken2_results)
    save_to_csv(output_loc + "/braken_results_" + basecaller_mapping[braken_report] + ".csv", braken_results)
